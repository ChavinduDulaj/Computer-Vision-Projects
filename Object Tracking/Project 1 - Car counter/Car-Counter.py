...
cap = cv2.VideoCapture('../Videos/cars.mp4') # For the videos
...
classnames = [
  ...
  "backpack","umbrella","handbag","tie","suitcase","frisbee","skis","snowboard","sports ball","kite","baseball bat","baseball glove",
    ...
    "sandwich","orange","broccoli","carrot","hot dog","pizza","donut","cake","chair","sofa","pottedplant","bed","diningtable","toilet","tvmonitor","laptop","mouse","remote","keyboard","cell phone","microwave","oven","toaster","sink","refrigerator","book","clock","vase","scissors","teddy bear","hair drier","toothbrush"
...
forward_shift = 165
limits[1] += forward_shift
limits[3] += forward_shift

horizontal_extension = 250
limits[0] -= horizontal_extension  # Decrease x-coordinate of the starting point
